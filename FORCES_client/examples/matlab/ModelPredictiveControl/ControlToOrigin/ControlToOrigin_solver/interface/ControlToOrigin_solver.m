% ControlToOrigin_solver - a fast solver generated by FORCESPRO v5.1.0
%
%   OUTPUT = ControlToOrigin_solver(PARAMS) solves a multistage problem
...
%
%   [OUTPUT, EXITFLAG] = ControlToOrigin_solver(PARAMS) returns additionally
...
%    -100 - License error
%
%   [OUTPUT, EXITFLAG, INFO] = ControlToOrigin_solver(PARAMS) returns 
