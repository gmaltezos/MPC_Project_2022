...
%   Copyright 2019-2021 The MathWorks, Inc.
    ...
    methods (Static)
        ...
        function updateBuildInfo(buildInfo, buildConfig)
            ...
            isDSpaceAutoBox = strcmpi(buildConfig.getConfigProp('SystemTargetFile'), 'rti1007.tlc');
            isDSpaceMicroLabBox = strcmpi(buildConfig.getConfigProp('SystemTargetFile'), 'rti1202.tlc');
            isDSpaceMABII = strcmpi(buildConfig.getConfigProp('SystemTargetFile'), 'rti1401.tlc');
            isDSpaceMABXIIIorSCALEXIO = strcmpi(buildConfig.getConfigProp('SystemTargetFile'), 'dsrt.tlc');
            ...
            elseif( ismac || isunix || isMinGW || isDSpace || isSpeedgoatQNX)
